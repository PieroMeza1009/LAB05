...
public class MainEjercicios {
    public static void main(String[] args) {
        ...
        Node<String> listaInvertida = Los_6Metodos.invertirLista(listaStr);
        System.out.print("Lista invertida: ");
        Los_6Metodos.imprimirLista(listaInvertida);
        ...
        Node<String> listaConcatenada = Los_6Metodos.concatenarListas(listaX, listaY);
        System.out.print("Lista concatenada: ");
        Los_6Metodos.imprimirLista(listaConcatenada);
    }
}